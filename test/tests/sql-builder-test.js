...
const query_generator_1 = require("../../src/sql/query-generator");
const assert = require("assert");
const modeler_1 = require("../../src/modeler");
const Sequelize = require('sequelize');
const diff_1 = require("../utility/diff");
const sequelize_client_1 = require("../../src/clients/sequelize-client");
...
const schema = new scheming_1.SchemaClass(require('../schema/game.json'));
const schema2 = new scheming_1.SchemaClass(require('../schema/game-2.json'));
const schema3 = new scheming_1.SchemaClass(require('../schema/game-3.json'));
const schema4 = new scheming_1.SchemaClass(require('../schema/game-4.json'));
const schema5 = new scheming_1.SchemaClass(require('../schema/game-5.json'));
const schema6 = new scheming_1.SchemaClass(require('../schema/game-6.json'));
const schema7 = new scheming_1.SchemaClass(require('../schema/game-7.json'));
const schema8 = new scheming_1.SchemaClass(require('../schema/game-8.json'));
