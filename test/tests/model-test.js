...
describe('Sequelize Test', function () {
    ...
    describe('Arbitrary Test', function () {
        ...
        it('arbitrary general', function () {
            return __awaiter(this, void 0, void 0, function () {
                var original, results, records, record;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 4:
                            ...
                            return [4 /*yield*/, model.OddRecord.update({
                                    strange: 11,
                                    unknown: "mist2"
                                }, {
                                    data: {
                        ...
                        case 5:
                            _a.sent();
                            return [4 /*yield*/, model.ground.querySingle("SELECT * FROM odd_records WHERE strange = 11")];
                        case 6:
                            record = _a.sent();
    ...
    describe('Indexless Test', function () {
        ...
        before(function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, initializeModel(client, 'indexless')];
                        case 1:
                            model = _a.sent();
                            return [2 /*return*/];
                    }
