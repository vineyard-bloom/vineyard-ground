...
function update_list<T>(tables: SequelizeTables, identity: any, seed: any, list: Property, table: TableClient<T>) {
...
function update_lists<T>(tables: SequelizeTables, identity: any, seed: any, trellis: Trellis, table: TableClient<T>) {
...
function post_process<T>(tables: SequelizeTables, result: any, identity: any, seed: any, trellis: Trellis, table: TableClient<T>): Promise<T> {
  processFields(result.dataValues, trellis)
  return update_lists(tables, identity, seed, trellis, table)
    .then(() => result.dataValues)
}

export function create<T>(tables: SequelizeTables, seed: any, trellis: Trellis, table: TableClient<T>): Promise<T> {
...
export function create_or_update<T>(tables: SequelizeTables, seed: any, trellis: Trellis, table: TableClient<T>): Promise<T> {
  const newSeed = prepare_seed(seed, trellis)
...
export function update<T>(tables: SequelizeTables, seed: any, trellis: Trellis, table: TableClient<T>, changes?: any): Promise<T> {
